...
def run_models_and_save_results(project_name: str, model_path: str) -> None:
    ...
    trained_before_names = extract(model_path, dataset_path, CODE2SEQ_VOCABULARY,
                                   os.path.join(result_folder, "trained_before_names.txt"))
    ...
    trained_after_names = extract(trained_path, dataset_path, CODE2SEQ_VOCABULARY,
                                  os.path.join(result_folder, "trained_after_names.txt"))
